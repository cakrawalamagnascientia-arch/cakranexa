...
> Jika `MIDTRANS_SERVER_KEY` belum diisi, checkout berjalan dalam **mode simulasi** (label "Mode Simulasi" tampil di layar pembayaran). Status pembayaran final di produksi selalu ditentukan oleh webhook Midtrans, bukan oleh klik pengguna.
