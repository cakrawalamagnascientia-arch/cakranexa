...
export const INITIAL_AUTHORS: Author[] = [
  {
    ...
    academic_titles: 'Pegawai Direktorat Jenderal Pajak, Kementerian Keuangan Republik Indonesia',
  ...
  },
  {
    ...
    academic_titles: 'S.E., M.Si., Ak., CA.',
  ...
  },
  {
    id: 'author-5',
    name: 'Wahyu Widodo',
    academic_titles: 'Dr. Wahyu Widodo, Ak., CA., S.H., M.Si.',
  ...
  },
  {
    id: 'author-6',
    name: 'Yudha Pramana',
    academic_titles: 'Akademisi dan pegawai Direktorat Jenderal Pajak, Kementerian Keuangan Republik Indonesia',
