...
const RAW_BOOKS: Book[] = [
  ...
  },
  {
    ...
    category: "Perpajakan",
    isbn: "978-634-05-3878-6",
    tahunTerbit: 2026,
    jumlahHalaman: 0,
    ukuranBuku: '155 x 230 mm (UNESCO B5)',
    harga: 185000,
    sinopsis: "Dalam praktik, struktur permodalan perusahaan adalah keputusan bisnis yang sangat wajar. Pembiayaan melalui utang sering dipilih karena efisiensi, fleksibilitas, dan kebutuhan ekspansi. Namun, dalam konteks perpajakan, porsi utang yang tidak proporsional berpotensi membuka ruang penggerusan basis pajak melalui pengakuan beban bunga yang berlebihan, terutama pada transaksi afiliasi. Di sinilah thin capitalization menjadi isu yang “sensitif”, berada di perbatasan antara strategi bisnis yang legitimate dan skema yang dapat mengarah pada penghindaran pajak yang agresif. Karena itu, pendekatan yang diperlukan tidak bisa semata-mata normatif, melainkan harus disertai pemahaman atas logika bisnis, prinsip kewajaran, manajemen risiko, serta dinamika kebijakan perpajakan yang terus berkembang.\n\nBuku ini disusun dengan tujuan memberikan gambaran yang komprehensif namun tetap praktis mengenai thin capitalization di Indonesia. Secara garis besar, pembahasan diarahkan pada tiga poros utama. Pertama, investasi, bagaimana kebijakan pembatasan biaya bunga dan aturan terkait dapat dirancang dan diterapkan tanpa menimbulkan ketidakpastian yang menghambat iklim usaha. Kedua, kepatuhan, bagaimana wajib pajak dapat menyusun struktur pembiayaan, dokumentasi, dan pembuktian yang memadai, serta bagaimana aparat pajak menilai secara proporsional dan berbasis risiko. Ketiga, keadilan pajak, bagaimana sistem memastikan kontribusi pajak sesuai kemampuan ekonomis, menciptakan level playing field antar pelaku usaha, dan menjaga penerimaan negara tanpa mengorbankan prinsip fairness.",
    linkPembelian: '#',
    bukuTerbaru: true,
    penerbit: 'PT Scientia Integritas Utama',
