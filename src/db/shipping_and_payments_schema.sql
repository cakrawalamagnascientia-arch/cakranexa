...
DROP POLICY IF EXISTS "Allow public read active shipping methods" ON public.shipping_methods;
...
DROP POLICY IF EXISTS "Allow public read active bank accounts" ON public.admin_bank_accounts;
...
CREATE TABLE IF NOT EXISTS public.payment_settings (
    ...
    qris_nmid VARCHAR(64) NOT NULL DEFAULT '',
    qris_image_url TEXT,

    admin_notification_whatsapp VARCHAR(32) NOT NULL DEFAULT '+6285286146806',
    admin_notification_email VARCHAR(128) NOT NULL DEFAULT 'info@cakranexa.com',
...
VALUES
('bank-mandiri-giro', 'Bank Mandiri', 'MANDIRI', '167-00-1164499-3', 'PT CAKRAWALA MAGNA SCIENTIA', '', true, true)
ON CONFLICT (id) DO NOTHING;
...
-- Update existing singleton rows when this script is run on an existing database.
UPDATE public.payment_settings
SET qris_nmid = '',
    admin_notification_whatsapp = '+6285286146806',
    admin_notification_email = 'info@cakranexa.com'
