  ...
  return (
    <div id="pelatihan-view" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-14 text-left font-sans space-y-10">
      ...
      <div className="p-6 sm:p-8 rounded-2xl bg-white border border-slate-200 shadow-xs flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <a
          href="https://wa.me/6281288992341?text=Halo%20CakraNexa%20Academy,%20kami%20ingin%20mengajukan%20proposal%20In-House%20Training%20untuk%20institusi/fakultas%20kami."
          target="_blank"
            ...
            {regSuccess ? (
              <div className="text-center py-6 space-y-4">
                ...
                <div className="pt-2 flex flex-col gap-2">
                  <a
                    href={`https://wa.me/6281288992341?text=Halo%20Admin%20CakraNexa%20Academy,%20saya%20telah%20mendaftar%20pelatihan%20"${selectedModuleForReg.title}"%20dengan%20Kode%20Registrasi%20${regSuccess}.`}
                    target="_blank"
                    rel="noopener noreferrer"
