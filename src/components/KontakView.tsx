            ...
            <div className="space-y-4 text-xs">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <span className="text-slate-600 font-mono block mt-0.5">+62 21 3912 8841</span>
                  <span className="text-slate-600 font-mono block">+62 812 8899 2341 (WhatsApp Redaksi)</span>
                </div>
              </div>
