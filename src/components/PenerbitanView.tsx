...
WhatsApp Dewan Redaksi: +62 812-8888-9999
          ...
          {submittedTicket ? (
            <div className="bg-white rounded-2xl border border-slate-200 p-8 sm:p-12 shadow-sm text-center space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center pt-2">
                <a
                  href={`https://wa.me/6281288992341?text=Halo%20Dewan%20Redaksi%20CakraNexa,%20saya%20telah%20mengajukan%20naskah%20dengan%20Kode%20Tracking%20${submittedTicket}.%20Mohon%20informasi%20tahapan%20selanjutnya.`}
                  target="_blank"
      ...
      {activeTab === 'faq' && (
        <div className="max-w-3xl mx-auto space-y-6 animate-in fade-in duration-200">
          ...
          <div className="p-5 rounded-xl bg-white border border-slate-200 shadow-xs flex flex-col sm:flex-row sm:items-center justify-between gap-4 mt-8">
            ...
            <a
              href="https://wa.me/6281288992341?text=Halo%20Redaksi%20CakraNexa,%20saya%20ingin%20berkonsultasi%20mengenai%20layanan%20penerbitan%20buku."
              target="_blank"
              rel="noopener noreferrer"
